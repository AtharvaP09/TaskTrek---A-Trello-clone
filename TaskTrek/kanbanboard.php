...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="kanbanboard.css">
    ...
    <body>
        <header>
            <div class="header-flex">
                ...
                <h1 id="title" class="text-align-center">Kanban Board</h1>
        ...
        <div class="container" id="main-container">
            <div id="cards-container">
                <div id="add-card">
                    <input maxlength="128" type="text" id="add-card-text" name="add-card" placeholder="Add Card..." autofocus style="color: white;">
...
var appData = {
    ...
    'currentBoard': 0,
    'identifier': 0,
    'username': '<?php echo $_SESSION['username']; ?>' // Add this line
};
...
function saveData() {
    window.localStorage.setItem('kards-appData-' + appData.username, JSON.stringify(appData));
}

function getDataFromLocalStorage() {
    return window.localStorage.getItem('kards-appData-' + appData.username);
}
function loadData() {
    let _data = window.localStorage.getItem('kards-appData-' + appData.username);
    if (_data) {
...
function clearData() {
    window.localStorage.removeItem('kards-appData-' + appData.username);
}
